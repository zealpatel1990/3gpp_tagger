...
class RulesTagger:
    ...
    def process_span_match(self):
        ...
        end_tag = self.strategy_config['span_match']['start_span_match']
    ...
    def call_strategy(self, input_sentence, strategy_config, start_index):
        self.input_sentence = input_sentence
        self.strategy_config = strategy_config
        self.start_index = start_index

        if self.strategy_config['function'] == self.process_span_match().__name__:
            return self.process_span_match()
        elif self.strategy_config['function'] == self.process_pattern_match().__name__:
